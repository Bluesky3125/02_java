...
public class Application2 {
    public static void main(String[] args) {
        ...
        *   3. System의 arraycopy()를 이용한 복사 (완전 일치 x, 일부 복사)
        *   4. Arrays의 copyOf()를 이용한 복사 (완전 일치 x, 일부 복사)
        * */
        ...
        /* 설명. 4. copyOf()를 이용한 복사(처음부터 원하는 길이만큼, 크기 지정을 할 필요가 없음) */
