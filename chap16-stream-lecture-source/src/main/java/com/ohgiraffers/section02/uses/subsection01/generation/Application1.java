...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 목차. 1. 배열로 Stream 생성 */
        /* 설명. Arrays.stream(배열): 배열의 자료형을 Stream 자료형으로 변환 */
        System.out.println("===== 배열로 스트림 생성 =====");
//        Stream<String> strStream1 = Arrays.stream(sArr);

        /* 설명. forEach는 자신의 매개변수에 정의된 람다식의 매개변수로
         *  stream의 각 요소들을 자동으로 넘기며 순회(매번 람다식 실행)
         * */
...
//        strStream1.forEach(System.out::println);
        ...
        /* 설명. Stream으로 관리되는 요소들을 원하는 횟수만큼 반복할 수 있다. */
