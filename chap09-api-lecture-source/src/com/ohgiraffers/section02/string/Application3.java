...
public class Application3 {
    public static void main(String[] args) {
        ...
        *               (String을 파싱(parsing)하여 String[]로 반환해 주고, []를 활용하여 구분자들을 넣어줄 수 있다.)
        *   2. StringTokenizer: 문자열의 모든 문자들을 구분자를 활용하여 문자열을 분리한다.
        *                       (StringTokenizer가 제공하는 메소드와 while문을 활용하여 띄어쓰기로 구분된 구분자들을 넣어줄 수 있다.)
        * */
        ...
        StringTokenizer colorStringTokenizer = new StringTokenizer(colors, ", ?");  // 구분자가 여러 개면 띄어쓰기로 구분
