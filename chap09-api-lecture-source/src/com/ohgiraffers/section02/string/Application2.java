...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 설명.
        *   문자열 객체를 만드는 방법
        *   1. "" 리터럴 형태: 동일한 값을 가지는 인스턴스(동등(equals, hashcode 오버라이드 되어있음))를 단일 인스턴스로 관리한다.
        *                    (일종의 singleton 개념, 상수 풀(constant pool) 활용(동등한 객체면 새로 추가하지 않음))
        ...
        * */
        ...
        System.out.println("hashCode()도 확인: str2(" + str2.hashCode() + "), str3(" + str3.hashCode() + ")");
