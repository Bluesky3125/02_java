...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 목차. 4. 논리값를 취급하는 자료형 */
        boolean isTrue;         //1byte(긍정의문문 형태의 변수명 권장)
        ...
        sNum = 2;
        iNum = 4;
        lNum = 2200000000L;     // 대략 21억(int 최대)이 넘으면 L을 붙여줘야한다. + long형 변수에 담아야 한다.

        fNum = 3.14f;           // 실수는 double형으로 인지하기 때문에 float형 변수에 담기 위해서는 f를 붙여야 한다.
        dNum = 3.14;

        ch = 'a';               // char는 숫자를 담을 수 있는데, 이는 양수만 가능하다.
        ch = 98;                // (∵ 아스키 코드나 유니코드 체계에는 음수가 없다.)
