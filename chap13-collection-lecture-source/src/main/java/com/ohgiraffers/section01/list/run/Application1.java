...
//        ArrayList list = new ArrayList();
        ...
        /* 설명. 모든 컬렉션은 toString이 잘 오버라이딩 되어 쉽게 출력해 볼 수 있다. */
        ...
        list.remove(0);
        System.out.println("list = " + list);
        System.out.println("첫 요소 제거 후 첫 요소: " + list.get(0));
        ...
        System.arraycopy(intArr, 0, intArr2, 0, index);
        intArr2[index] = plus;
        System.arraycopy(intArr, index, intArr2, index + 1, intArr2.length - (index + 1));
        System.out.println(Arrays.toString(intArr2));

        /* 설명. ArrayList를 활용한 정렬*/
        /* 목차. 1. 문자열 데이터 정렬(feat. 오름차순) */
//        List<String> stringList = new ArrayList<>();
        List<String> stringList = new LinkedList<>();       // 내림차순할 때는 LinkedList로 변경
        /* 설명. 은닉화(hiding)
         *  유지보수를 위해 적용
         *   - 타입 은닉(다형성)
         *   - 구현 은닉(인터페이스 활용)
