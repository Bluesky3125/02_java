...
//        rabbit.jump();
        ...
        /* 설명. Animal은 Tiger나 Rabbit이 아니다.(Tiger 또한 Rabbit 타입을 지니고 있지 않다.) */
//        Tiger t1 = new Rabbit()   // 다형성 X

        /* 설명. 동적 바인딩 확인하기
        *   컴파일 당시에는 해당 타입의 메소드와 연결되어 있다가
        *   런타임 당시 실제 객체가 가진 오버라이딩 된 메소드로 바인딩되어 바뀌어 동작하는 것을 의미한다.
        ...
        * */
        ...
        /* 설명. 부모타입을 강제로 자식 타입으로 형변환하는 것이 가능하다.(단, 조심해야 한다.) */
//        ((Tiger) an2).bite();
