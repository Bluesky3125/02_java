...
public class Application {
        ...
        while (true) {
            ...
            switch (chooseNo) {
                ...
                case 3:
                    ...
                    modifyMember.setHobbies(resetHobbies());    // 배열은 단순 Scanner로 입력 불가
                    break;
                case 4:
                    System.out.print("수정할 혈액형을 입력하세요.");
                    modifyMember.setBloodType(resetBloodType());    // enum은 단순 Scanner로 입력 불가
                    break;
                case 9:
    ...
    private static Member signUp() {
        ...
        return new Member(id, pwd, age, hobbies, bt);
    }
